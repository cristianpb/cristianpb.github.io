...
average and inference time is about 2.31 seconds. Which is real-time gives the
following output.
...
The complete code can be found [here for the Mobilenet model](https://github.com/cristianpb/object-detection/blob/master/ssd_detection.py)
and [here for yolo](https://github.com/cristianpb/object-detection/blob/master/yolo_detection.py)
